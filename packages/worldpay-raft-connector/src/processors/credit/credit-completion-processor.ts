...
async function handleMessage(transaction: Transaction, message: CreditCompletion): Promise<PaymentExtensionResponse> {
  log.debug(`Handle message for creditcompletion with APITransactionID=${message?.creditcompletion?.APITransactionID}`)
